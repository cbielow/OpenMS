...
const XMLCh blocktest[] = {0x0048,0x0065,0x006C,0x0000,0x666F,0x102C,0x0257,0x506F};

const XMLCh block16[] = {0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0000};

const XMLCh block24[] = {0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0000};

const XMLCh block26negative[] = {0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0157,0x006F,0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0057,0x006F,0x0000};
...
const XMLCh block32[] = {0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F
                         ,0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0048,0x0065,0x006C,0x006C,0x006F,0x002C,0x0057,0x006F,0x0000};
...
START_SECTION(isASCII(const XMLCh * chars, const XMLSize_t))
  isAscii = StringManager::isASCII(blocktest);
  std::cout << "1 \n";
  TEST_EQUAL(isAscii,1)
  isAscii = StringManager::isASCII(russianHello);
  std::cout << "2 \n";
  TEST_EQUAL(isAscii,-1)
  isAscii  = StringManager::isASCII(mixed);
  std::cout << "3 \n";
  TEST_EQUAL(isAscii,-1)
  isAscii = StringManager::isASCII(empty);
  std::cout << "4 \n";
  TEST_EQUAL(isAscii,-1)
  isAscii = StringManager::isASCII(upperBoundary);
  std::cout << "5 \n";
  TEST_EQUAL(isAscii,1)
  isAscii = StringManager::isASCII(block16);
  std::cout << "6 \n";
  TEST_EQUAL(isAscii,1)
  isAscii = StringManager::isASCII(block32);
  std::cout << "7 \n";
  TEST_EQUAL(isAscii,1)
  isAscii = StringManager::isASCII(block24);
  std::cout << "8 \n";
  TEST_EQUAL(isAscii,-1)
  isAscii = StringManager::isASCII(block26negative);
  std::cout << "9 \n";
  TEST_EQUAL(isAscii,-1)
