...
public:
    ...
    void pushDataDouble(OpenMS::String, std::vector<double>);
    ...
    std::vector<double>getDoublesByHead(OpenMS::String);
protected:
    ...
    std::map<OpenMS::String,std::vector<double>> DataStringDouble_;
    bool isfilled_;
