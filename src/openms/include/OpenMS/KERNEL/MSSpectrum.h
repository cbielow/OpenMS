...
public:
  ...
  */
  ...
  /**
    ...
    @param chunks a Chunk is an object that contains the start and end of a sublist of peaks in the spectrum, that is or isn't sorted yet (is_sorted
    member)
  */
  ...
  */
  ...
  /**
    ...
    This only works for spectra which represent an IM-frame, i.e. they have a float metadata array which is a child of 'MS:1002893 ! ion mobility
    array'? Check this first by using `containsIMData()`.
  ...
  */
  ...
  /**
    ...
    This only works for spectra which represent an IM-frame, i.e. they have a float metadata array which is a child of 'MS:1002893 ! ion mobility
    array'. If this is not present, this returns {DriftTimeUnit::NONE, {}}
  */
