...
TMTTenPlexQuantitationMethod::TMTTenPlexQuantitationMethod() :
    IsobaricQuantitationMethod(MethodType::TMT_10PLEX)
{
    ...
    channels_.push_back(IsobaricChannelInformation("129C", 6, "", TMTMasses::TMT_129C, {2,  4,  8, -1}));
    channels_.push_back(IsobaricChannelInformation("130N", 7, "", TMTMasses::TMT_130N, {3,  5,  9, -1}));
    channels_.push_back(IsobaricChannelInformation("130C", 8, "", TMTMasses::TMT_130C, {4,  6, -1, -1}));
    channels_.push_back(IsobaricChannelInformation("131",  9, "", TMTMasses::TMT_131N, {5,  7, -1, -1}));
