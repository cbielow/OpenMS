...
TMTSixteenPlexQuantitationMethod::TMTSixteenPlexQuantitationMethod() :
    IsobaricQuantitationMethod(MethodType::TMT_16PLEX)
{
    ...
    channels_.push_back(IsobaricChannelInformation("132C", 12, "", TMTMasses::TMT_132C, { 8, -1, 10, -1,   13, 14, 15, -1}));
    channels_.push_back(IsobaricChannelInformation("133N", 13, "", TMTMasses::TMT_133N, { 9, 10, 11, 12,   -1, 15, -1, -1}));
    channels_.push_back(IsobaricChannelInformation("133C", 14, "", TMTMasses::TMT_133C, {10, -1, 12, -1,   15, -1, -1, -1}));
    channels_.push_back(IsobaricChannelInformation("134N", 15, "", TMTMasses::TMT_134N, {11, 12, 13, 14,   -1, -1, -1, -1}));
