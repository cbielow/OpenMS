...
channelTolerances, classifyChannels, kitScore) are exposed as static methods.
    ...
    nb::class_<OpenMS::IsobaricKitDetection::Parameters>(ikd_class, "Parameters", "Tunable thresholds for detection")
        ...
        .def_rw("percent_summed_intensity_explained", &OpenMS::IsobaricKitDetection::Parameters::percent_summed_intensity_explained)
    ...
    nb::class_<OpenMS::IsobaricKitDetection::KitResult>(ikd_class, "KitResult", "Result for one candidate isobaric kit")
        ...
        .def_rw("explained_signal_fraction", &OpenMS::IsobaricKitDetection::KitResult::explained_signal_fraction)
        .def_rw("labeled_spectra_fraction", &OpenMS::IsobaricKitDetection::KitResult::labeled_spectra_fraction)
